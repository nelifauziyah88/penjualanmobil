...
<body>
    <div class="position-relative">
        <img src="{{ asset('images/mobile_legends_banner.jpeg') }}" alt="MOBILE LEGENDS Banner" class="header-image">
    </div>

    <div class="container position-relative">
        <div class="d-flex align-items-end mb-4">
            <img src="{{ asset('images/mobile_legends.jpg') }}" alt="PUBG Mobile Logo" class="game-logo">
            <div class="text-white ms-3 mb-4">
                <h1 class="fs-2 fw-bold mb-0">MOBILE LEGENDS</h1>
            ...
            <div class="row">
                ...
                <div class="col-md-9">
                    ...
                    <div class="row">
                        ...
                        ['50 Diamonds', '14.300'],
                        ['80 Diamonds', '138.000'],
                        ['170 Diamonds', '198.000'],
                        ['240 Diamonds', '265.000'],
                        ['296 Diamonds', '331.000'],
                        ['408 Diamonds', '392.000'],
                        ['508 Diamonds', '459.000'],
                        ['768 Diamonds', '519.000']
                        ] as $product)
                        <div class="col-md-4">
